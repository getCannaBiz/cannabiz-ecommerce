...
?>
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="entry-content order-details">
            ...
            echo '<p><strong>' . esc_attr__( 'Date', 'cannabiz-menu' ) . ':</strong></p>';
            ...
            echo '<p><strong>' . esc_attr__( 'Name', 'cannabiz-menu' ) . ':</strong></p>';
            ...
            echo '<tr><td><strong>' . esc_attr__( 'Subtotal', 'cannabiz-menu' ) . ':</strong></td><td>' . CURRENCY . $order_details['subtotal'] . '</td></tr>';
            if ( isset( $order_details['coupon_amount'] ) && '0.00' !== $order_details['coupon_amount'] ) {
                echo '<tr><td><strong>' . esc_attr__( 'Coupon', 'cannabiz-menu' ) . ':</strong></td><td>-' . CURRENCY . $order_details['coupon_amount'] . '</td></tr>';
            }
            if ( isset( $order_details['sales_tax'] ) && '0.00' !== $order_details['sales_tax'] ) {
                echo '<tr><td><strong>' . esc_attr__( 'Sales tax', 'cannabiz-menu' ) . ':</strong></td><td>' . CURRENCY . $order_details['sales_tax'] . '</td></tr>';
            }
            if ( isset( $order_details['excise_tax'] ) && '0.00' !== $order_details['excise_tax'] ) {
                echo '<tr><td><strong>' . esc_attr__( 'Excise tax', 'cannabiz-menu' ) . ':</strong></td><td>' . CURRENCY . $order_details['excise_tax'] . '</td></tr>';
            }
            echo '<tr><td><strong>' . $order_details['payment_type']['name'] . ':</strong></td><td>' . CURRENCY . $order_details['payment_type']['amount'] . '</td></tr>';
            echo '<tr><td><strong>' . esc_attr__( 'Total', 'cannabiz-menu' ) . ':</strong></td><td>' . CURRENCY . $order_details['total'] . '</td></tr>';
            echo '</tbody></table>';
            echo '</div>';
            ...
            echo '<h3>' . esc_attr__( 'Order items', 'cannabiz-menu' ) . '</h3>';
            if ( 'customer' === $role[0] ) {
